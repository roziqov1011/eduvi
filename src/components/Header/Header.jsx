      ...
      <header className="header">
        <div className="container">
          <div className="nav">
            ...
            <select name="" id="">
              <option value="forKindergarten" selected>
                For Kindergarten
              </option>
            </select>
            <select name="" id="">
              <option value="forSchool" selected>
                For High School
              </option>
            </select>
            <select name="" id="">
              <option value="forCollage" selected>
                For College
              </option>
            </select>
            <select name="" id="">
            ...
            <Link to={"/accaunt"}>
              My Account <img className="nav__icon" src={AccIcon} alt="" />{" "}
            </Link>
          </div>
        </div>
      </header>
